...
class gradRateAPI:
    ...
    def findGradRate(self, schoolDistrict, cohort, connection):
        ...
        if self.isValidCohort(cohort):
            ...
            try:
                ...
                query = "SELECT convertedRate,stateName from gradratetable WHERE districtName=%s AND category=%s"
    ...
    def findAllGradRates(self, schoolDistrict, connection):
        ...
        try:
            cursor = connection.cursor()
            query = "SELECT category,convertedRate,stateName from gradratetable WHERE districtName=%s"
    ...
    def listLowerDistricts(self, maxGradRate, cohort, maxListSize, connection):
        ...
        try:
            cursor = connection.cursor()
            query = "SELECT districtName,convertedRate,stateName from gradratetable WHERE category=%s AND convertedRate<%s ORDER BY convertedRate DESC LIMIT %s"
    ...
    def listHigherDistricts(self, minGradRate, cohort, maxListSize, connection):
        ...
        try:
            cursor = connection.cursor()
            query = "SELECT districtName,convertedRate,stateName from gradratetable WHERE category=%s AND convertedRate>%s ORDER BY convertedRate ASC LIMIT %s"
